...
export const faq = [
  {
    ...
    a: 'We work with small and mid-sized businesses across sectors like healthcare, education, real estate, manufacturing, hospitality, retail and professional services — from single-person operations to growing teams.',
  },
  {
  ...
  {
    q: 'Can you build Android and iOS applications?',
    a: 'Yes. We build Android, iOS and cross-platform mobile applications — customer-facing apps as well as internal workforce apps connected to backend systems.',
  },
  {
    q: 'Can you maintain an existing website?',
    a: 'Yes. We take on maintenance for existing sites — fixes, updates, performance work, security patches and incremental improvements.',
  },
  {
    q: 'Can you improve an existing software product?',
    a: 'Yes. We audit, modernize and rebuild parts of existing products without a full rewrite where possible.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. We can implement designs delivered by another designer, or design in-house — whichever fits the project.',
  },
  {
  ...
  {
    q: 'Can you build custom business management systems?',
    a: 'Yes. CRMs, inventory systems, booking systems, admissions, HR, dashboards and other management systems — built to match the workflow, not a generic template.',
  },
];
